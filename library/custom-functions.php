    ...
    $raw_excerpt = $wpse_excerpt;
      if ( '' == $wpse_excerpt ) {
        ...
        if ( $count >= $excerpt_word_count ) {
          $excerpt_end = '[&hellip;]&nbsp;<a href="'. esc_url( get_permalink() ) . '">' . sprintf(__( 'Read more &nbsp;&raquo;', 'wpse' )) . '</a>';
...
// Get whatever the ID is if you know what the slug will be
...
// Check URLs before using file_get_contents
